...
from base_model import InputFeatures, TransformerBase
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if model_type == "quant_bert" and load_quantized:
            ...
            # self.model.apply(reset_wgt_alpha)
            self.model.apply(kl_divergence_initilization)
            print("reset weight alpha!")
